...
//   },
//   statusConfirmed: {
//     color: "#28a745", // Green for confirmed status
//   },
//   statusPending: {
    ...
    <>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate("ProfileScreen")}>
          <Image
            source={profile} // Placeholder for profile picture
            style={styles.profileImage}
          />
        </TouchableOpacity>
      </View>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              if (action.name === "Book Appointment") {
                ...
                navigation.navigate("QueueStatusScreen"); // Navigate to QueueStatusScreen
              } else if (action.name === "Medical Records") {
                navigation.navigate("MedicalRecordsScreen"); // Navigate to MedicalRecordsScreen
              } else if (action.name === "Prescriptions") {
                navigation.navigate("PrescriptionsScreen"); // Navigate to PrescriptionsScreen
              }
            }}
          >
            <Ionicons name={action.icon} size={24} color="#fff" />
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        ListHeaderComponent={renderHeader} // Render static content before the notifications list
        showsVerticalScrollIndicator={false}
      />
    </View>
  );
